...
- [x] **2026-02-21** `ui`: 实现下拉框搜索过滤、按钮区流式自动换行布局和卡片式兴趣标签组件
- [x] **2026-02-21** `ui`: 合并左右两个输入区为统一的「当前用户」搜索框，支持 ID/姓名双轨联想
- [x] **2026-02-21** `fix`: 修复联想弹出后抢占键盘焦点导致无法连续输入的问题
- [x] **2026-02-21** `fix`: 修复中文输入法被联想刷新打断、拼音无法正常上屏的问题（增加防抖缓存）
- [x] **2026-02-21** `fix`: 修复退格删除后联想列表不更新的问题
